...
SECRET_KEY = 'django-insecure-e*r_2a&ygklsd70(ka@#1@gt#i=0wj_xnz=93(=fnk(uihj_#^'
...
EMAIL_HOST_USER = 'oscar.r.portafolio@gmail.com'
EMAIL_HOST_PASSWORD = 'qztgudmttcxpjloz'
EMAIL_PORT = 587
...
STATIC_URL = '/static/'  # URL para acceder a los archivos estáticos en desarrollo
...
AUTHENTICATION_BACKENDS = ['api.backend.MyBackend', 'django.contrib.auth.backends.ModelBackend']
